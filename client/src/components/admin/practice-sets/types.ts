...
export interface PracticeSet {
  ...
  relatedTopicId?: number | null;        // ID of the related quant/verbal topic
  relatedTopicType?: string | null;      // "quantitative" or "verbal"
  showInTopic?: boolean;                 // Whether to show this practice set in the topic view
}
...
export const practiceSetSchema = z.object({
  ...
  subtypeFilter: z.string().nullable().optional(),
...
// Question subtype options by type
