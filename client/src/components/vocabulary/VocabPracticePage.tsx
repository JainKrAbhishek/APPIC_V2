...
import { useVocabularyPractice } from '@/components/vocabulary/hooks';
...
const VocabPracticePage: React.FC<VocabPracticePageProps> = ({ onBackToPractice }) => {
  ...
  // Handle back to practice navigation
  const handleBackToPractice = () => {
    if (typeof onBackToPractice === 'function') {
      // If callback is provided (from direct parent component), use it
      onBackToPractice();
    } else {
      // Otherwise, use router to navigate to practice
